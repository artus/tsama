...
},{"tsamagotchi":2}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Tsamagotchi = /** @class */ (function () {
    /**
    ...
    */
    function Tsamagotchi(name, foodLimit) {
        if (name === void 0) { name = "Your new Tsamagotchi"; }
        if (foodLimit === void 0) { foodLimit = 100; }
        this.name = name;
        this._age = 0;
    ...
    Object.defineProperty(Tsamagotchi.prototype, "age", {
        /**
    ...
    Object.defineProperty(Tsamagotchi.prototype, "birthdate", {
        /**
    ...
    Object.defineProperty(Tsamagotchi.prototype, "health", {
        /**
    ...
    Object.defineProperty(Tsamagotchi.prototype, "satiety", {
        /**
    ...
    Object.defineProperty(Tsamagotchi.prototype, "happiness", {
        /**
    ...
    Object.defineProperty(Tsamagotchi.prototype, "isAlive", {
        /**
    ...
    Object.defineProperty(Tsamagotchi.prototype, "foodLimit", {
        /**
    ...
    */
    Tsamagotchi.prototype.feed = function (amount) {
    ...
    */
    Tsamagotchi.prototype.mature = function (amount) {
        if (amount === void 0) { amount = 1; }
        if (!this.isAlive)
            return this.health;
        if (this.isAlive) {
    ...
    */
    Tsamagotchi.prototype.digest = function (amount) {
        if (amount === void 0) { amount = 1; }
        if (!this.isAlive)
            return this.satiety;
        this._satiety -= amount;
    ...
    */
    Tsamagotchi.prototype.heal = function (amount) {
        if (amount === void 0) { amount = 1; }
        if (!this.isAlive)
            return this.health;
        this._health += amount;
    ...
    */
    Tsamagotchi.prototype.love = function (amount) {
        if (amount === void 0) { amount = 1; }
        if (!this.isAlive)
    ...
    */
    Tsamagotchi.prototype.decreaseHappiness = function (amount) {
        if (amount === void 0) { amount = 1; }
        if (!this.isAlive)
            return this.happiness;
        this._happiness -= amount;
    ...
    */
    Tsamagotchi.prototype.decreaseHealth = function (amount) {
        if (amount === void 0) { amount = 1; }
        if (!this.isAlive)
            return this.health;
        this._health -= amount;
    ...
    */
    Tsamagotchi.prototype.die = function () {
        this._isAlive = false;
        this._health = 0;
    };
    return Tsamagotchi;
}());
exports.Tsamagotchi = Tsamagotchi;
